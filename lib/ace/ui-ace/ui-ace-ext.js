 ...
 */
angular.module('ui.ace.ext', [])
  .constant('uiAceConfig', {})
  .directive('uiAceExt', ['uiAceConfig', '$parse', function (uiAceConfig, $parse) {
     ...
     */
  	...
  	return {
  		...
  		link: function (scope, elm, attrs, ngModel) {
			 ...
			 * @type object
			 */
  			var opts = angular.extend({}, options, scope.$eval(attrs.uiAceExt));
			 ...
			 */
  			...
  			scope.$watch(attrs.uiAceExt, function (current, previous) {
  				if (current === previous) return;
  				opts = angular.extend({}, options, scope.$eval(attrs.uiAceExt));
