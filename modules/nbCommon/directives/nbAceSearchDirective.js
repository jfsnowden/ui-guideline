(function (netBrain) {
    ...
    function nbAceSearchController($scope) {
        ...
        var findAll = function () {
            ...
            searchResults = aceFindAll(getValueOrFuncValue($scope.searchOptions.filterText), { start: new Range(0, 0, -1, -1), wholeWord: getValueOrFuncValue($scope.searchOptions.matchWholeWord) });
