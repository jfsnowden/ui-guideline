...
(function() {
    ...
    function nbCarouselSliderDirective($timeout) {
        var directive = {
            ...
            scope: {},
            transclude: true,
            template: '<div class="slider-backward-btn">' +
        ...
        function compile() {
            return {
                ...
                post: function(scope, element, attr) {
                    $timeout(function() {
                        var pluswidth = '0';
                        if ({}.hasOwnProperty.call(attr, 'pluswidth')) {
                        ...
                        scope.callSliding = function(direction) {
